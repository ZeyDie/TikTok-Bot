                        ...
                        () -> {
                            try {
                                ...
                                if (tiktokItemListData != null)
                                    builder.append(localize.localize("messages.comments")).append(tiktokItemListData.getCommentCounts()).append("\n")
                                            .append(localize.localize("messages.shares")).append(tiktokItemListData.getShareCounts()).append("\n");

                                builder.append(localize.localize("messages.region")).append(localize.localize(tikTokUserData.getRegion())).append("\n")
